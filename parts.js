window.PC_BUILDER_PARTS = {
      cpu: {
        ...
        i5_12400f: { model: "Intel Core i5-12400F（无核显，必须搭配独显）", price: 900 },
        i5_12490f: { model: "Intel Core i5-12490F（无核显，需独显）", price: 945 },
        i5_13400f: { model: "Intel Core i5-13400F（无核显，必须搭配独显）", price: 957 },
        i5_14400f: { model: "Intel Core i5-14400F（无核显，需独显）", price: 995 },
        r5_5600g: { model: "AMD Ryzen 5 5600G（带核显，低预算过渡）", price: 739 },
        r5_5600: { model: "AMD Ryzen 5 5600（无核显，通常搭配独显）", price: 699 },
        r7_5700x3d: { model: "AMD Ryzen 7 5700X3D（AM4/DDR4，网游缓存版）", price: 1799 },
        r7_5800x3d: { model: "AMD Ryzen 7 5800X3D（AM4/DDR4，老平台高刷网游）", price: 3387 },
        r5_7500f: { model: "AMD Ryzen 5 7500F（无核显，必须搭配独显）", price: 649 },
        ...
        r7_7800x3d: { model: "AMD Ryzen 7 7800X3D（AM5/DDR5，游戏强）", price: 1750 },
        r7_9700x: { model: "AMD Ryzen 7 9700X（AM5/DDR5，新平台 8 核）", price: 1458 },
        r7_9800x3d: { model: "AMD Ryzen 7 9800X3D（AM5/DDR5，高端游戏）", price: 2550 },
        r9_7900x3d: { model: "AMD Ryzen 9 7900X3D（AM5，多核/X3D，非纯网游首选）", price: 3299 },
        r9_7950x3d: { model: "AMD Ryzen 9 7950X3D（AM5，多核/X3D，剪辑生产力向）", price: 3699 },
        r9_9950x3d: { model: "AMD Ryzen 9 9950X3D（AM5，旗舰多核/X3D，生产力向）", price: 5999 },
      },
      gpu: {
        ...
        rx6650xt: { model: "RX 6650 XT 8GB（1000–1200 元档重点参考）", price: 1569 },
        ...
        rx6750gre: { model: "RX 6750 GRE 10GB（全新/清仓，2K 入门）", price: 1799 },
        rtx4060: { model: "RTX 4060 8GB（全新省电，DLSS 友好）", price: 1917 },
        rtx5050: { model: "RTX 5050 8GB（全新低功耗轻网游，不主推性能）", price: 1999 },
        rtx5060: { model: "RTX 5060 8GB（全新 N 卡入门，差价小时优先看 5060Ti）", price: 2489 },
        rtx4060ti: { model: "RTX 4060 Ti 8GB", price: 2050 },
        rx7700xt: { model: "RX 7700 XT 12G（2K 入门/中端性能）", price: 2349 },
        rx7800xt: { model: "RX 7800 XT 16G", price: 2758 },
        rtx4070: { model: "RTX 4070 12G（全新/二手价格差异大）", price: 3499 },
        rtx4070super: { model: "RTX 4070 SUPER 12G（2K N 卡甜点）", price: 4509 },
        rtx4070ti: { model: "RTX 4070 Ti 12G（高性能但显存偏紧）", price: 4599 },
        rtx4070tis: { model: "RTX 4070 Ti SUPER 16G（更适合 2K/创作）", price: 5000 },
        rtx5060ti8: { model: "RTX 5060 Ti 8G（注意和 16G 版区分）", price: 2699 },
        rx9070: { model: "RX 9070 16G（全新 2K 高性能）", price: 3849 },
        rx9070xt: { model: "RX 9070 XT 16G（全新高性能，价格波动大）", price: 4499 },
        rtx5060ti16: { model: "RTX 5060 Ti 16G（全新大显存版）", price: 3800 },
        rtx5070: { model: "RTX 5070 12GB（全新高预算游戏卡）", price: 4400 },
