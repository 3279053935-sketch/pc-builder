window.PC_BUILDER_PARTS = {
      cpu: {
        ...
        r7_5700x3d: { model: "AMD Ryzen 7 5700X3D（AM4/DDR4，网游缓存版）", price: 1399 },
        r7_5800x3d: { model: "AMD Ryzen 7 5800X3D（AM4/DDR4，老平台高刷网游）", price: 1799 },
        ...
        r7_7800x3d: { model: "AMD Ryzen 7 7800X3D（AM5/DDR5，游戏强）", price: 1999 },
        r7_9700x: { model: "AMD Ryzen 7 9700X（AM5/DDR5，新平台 8 核）", price: 1899 },
        r7_9800x3d: { model: "AMD Ryzen 7 9800X3D（AM5/DDR5，高端游戏）", price: 3299 },
      ...
      gpu: {
        ...
        rx6650xt: { model: "RX 6650 XT 8GB（1000–1200 元档重点参考）", price: 1499 },
        rx7600: { model: "RX 7600 8GB（全新主流 1080P）", price: 1729 },
        ...
        rtx4060: { model: "RTX 4060 8GB（全新省电，DLSS 友好）", price: 1849 },
        rtx5050: { model: "RTX 5050 8GB（全新低功耗轻网游，不主推性能）", price: 1999 },
        rtx5060: { model: "RTX 5060 8GB（全新 N 卡入门，差价小时优先看 5060Ti）", price: 2169 },
        rtx4060ti: { model: "RTX 4060 Ti 8GB", price: 2399 },
        rx7700xt: { model: "RX 7700 XT 12G（2K 入门/中端性能）", price: 2899 },
        rx7800xt: { model: "RX 7800 XT 16G", price: 3299 },
        rtx4070: { model: "RTX 4070 12G（全新/二手价格差异大）", price: 3849 },
        rtx4070super: { model: "RTX 4070 SUPER 12G（2K N 卡甜点）", price: 4299 },
        rtx4070ti: { model: "RTX 4070 Ti 12G（高性能但显存偏紧）", price: 4599 },
        rtx4070tis: { model: "RTX 4070 Ti SUPER 16G（更适合 2K/创作）", price: 4900 },
        rtx5060ti8: { model: "RTX 5060 Ti 8G（注意和 16G 版区分）", price: 2639 },
        rx9070: { model: "RX 9070 16G（全新 2K 高性能）", price: 3999 },
        rx9070xt: { model: "RX 9070 XT 16G（全新高性能，价格波动大）", price: 4699 },
        rtx5060ti16: { model: "RTX 5060 Ti 16G（全新大显存版）", price: 3199 },
        rtx5070: { model: "RTX 5070 12GB（全新高预算游戏卡）", price: 4299 },
